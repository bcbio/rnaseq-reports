...
metaD <- glue("{DEG_outputF}/DEGpattern_deseq_meta.rds")
...
ui <- dashboardPage(
  ...
  dashboardBody(
    ...
    fluidRow(
      box(
        title = "Pathways Associated with Gene", width = 12, solidHeader = TRUE, status = "primary",
    ...
    fluidRow(
      ...
      column(
        width = 6,
        box(
          title = "Expression Boxplot", width = NULL, solidHeader = TRUE, status = "primary",
